...
class Turnir extends Component
{
    ...
    public function turnir()
    {
        ...
        $arr[429] = ['name' => 'Umidaxon O','ball' => 15];
        $arr[64] = ['name' => 'Dilrabo N','ball' => 15];
        $arr[286] = ['name' => 'Elmira B','ball' => 15];
        $arr[86] = ['name' => 'Shaxnoza S','ball' => 15];
        $arr[279] = ['name' => 'Aziza N','ball' => 15];
        $arr[323] = ['name' => 'Qizlarxon T','ball' => 15];
        $arr[454] = ['name' => 'Janat B','ball' => 15];
        $arr[499] = ['name' => 'Bibinaz A','ball' => 15];
        $arr[172] = ['name' => 'Nasiba X','ball' => 15];

        $arr[491] = ['name' => 'Rushana Y','ball' => 15];
        $arr[470] = ['name' => 'Kumush E','ball' => 15];
        $arr[508] = ['name' => 'Malika X','ball' => 15];

        $arr[79] = ['name' => 'Komola I','ball' => 15];
        $arr[502] = ['name' => 'Mavjuda Q','ball' => 15];
        $arr[500] = ['name' => 'Xurshida X','ball' => 15];


        $arr[483] = ['name' => 'Gozal A','ball' => 15];
        $arr[443] = ['name' => 'Maftuna S','ball' => 15];
        ...
        $arr[498] = ['name' => 'Dilrabo A','ball' => 15];
        $arr[488] = ['name' => 'Shukrona Q','ball' => 15];
        $arr[504] = ['name' => 'Sayfura O','ball' => 15];
        ...
        $arr[344] = ['name' => 'Dilfuza X','ball' => 15];
        ...
        foreach ($users_battles as $key => $value) {
            $sold1 = AllSold::where('user_id',$value->user1id)
                ->whereDate('created_at','=',date('2023-11-24'))
