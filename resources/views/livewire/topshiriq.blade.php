<div class="modal-content">
    ...
    <div class="modal-body" style="background-image: url(/promo/dist/img/promo/bg2.png); padding: 2rem !important;">

            {{--        Oltin sut--}}
            @if($oltin_sut_topshiriq_javob && $oltin_sut_topshiriq_javob->status == 1)
            <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg125.svg);background-size: cover;height: 72px; margin-bottom: 15px">
                ...
                <div class="col-7 text-center">
                    <h6 style="font-family: Supercell-Magic;font-size: 13px;color: #131313;margin-top: 10px">{{$oltin_sut_topshiriq_name->name}}</h6>
                    <svg width="100%" height="30">
                        <text x="10" y="15" font-family="Supercell-Magic" font-size="17" fill="white" stroke="#d6ba93" stroke-width="1">Topshiriq bajarildi</text>
                    </svg>
                </div>

                <div class="col-2" style="padding: 0 !important;">
                    <h6 style="font-family: Supercell-Magic;font-size: 13px;color: white;margin-bottom: 0 !important;">Yutuq</h6>
                ...
                <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg125.svg);background-size: cover;height: 72px; margin-bottom: 15px">
                    ...
                    <div class="col-7 text-center">
                        ...
                        <svg width="280px" height="30">
                            <text y="15" font-family="Supercell-Magic" font-size="17" fill="white" stroke="#d6ba93" stroke-width="1">Topshiriq bajarilmadi</text>
                        </svg>
                    </div>
                    <div class="col-2" style="margin: auto;padding: 0 !important; text-align: center">
                        <img src="{{asset('images/jang_topshiriq/toj.svg')}}" height="30" alt="">
            ...
            @else
                <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg100.svg);margin-bottom: 15px;background-size: cover;height: 105px;background-repeat: no-repeat;width: 470px;">
                    <div class="col-2" style="padding: 0 !important; text-align: center">
                        ...
                        <span style="font-family: 'Supercell-Magic'; font-size: 10px; text-align: center;margin: 15px; color: #d6bbbb;">
                    {{$oltin_sut}} / {{$oltin_sut_topshiriq_name->number}}
                </span>
                    </div>
                    <div class="col-7" style="padding: 0 !important;text-align: center">
                        <h6 style="font-family: Supercell-Magic; font-size: 14px; color: white;margin-bottom: 0 !important;margin-top: 20px">{{$oltin_sut_topshiriq_name->name}}</h6>
                    ...
                    <div class="col-2" style="padding: 0 !important;">
                        ...
                        <span style="font-family: Supercell-Magic;font-size: 10px;color: white;margin-left: 20px">
                            {{$oltin_sut_topshiriq_name->star}}
                        </span>
            ...
            <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg125.svg);background-size: cover;height: 72px; margin-bottom: 15px">
                ...
                <div class="col-7 text-center">
                    <h6 style="font-family: Supercell-Magic;font-size: 13px;color: #131313;margin-top: 10px">{{$suyak_komplex_topshiriq_name->name}}</h6>
                    <svg width="100%" height="30">
                        <text x="10" y="15" font-family="Supercell-Magic" font-size="17" fill="white" stroke="#d6ba93" stroke-width="1">Topshiriq bajarildi</text>
                    </svg>
                </div>
            ...
            @else
                <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg100.svg);margin-bottom: 15px;background-size: cover;height: 105px;background-repeat: no-repeat;width: 470px;">
                    ...
                    <div class="col-7" style="padding: 0 !important;text-align: center">
                        <h6 style="font-family: Supercell-Magic; font-size: 14px; color: white;margin-bottom: 0 !important;margin-top: 20px">{{$suyak_komplex_topshiriq_name->name}}</h6>
                        <div style="margin-top: 15px;margin-bottom: 15px;">
                            <svg width="150" height="35" style="background: #0c60ac; border-radius: 8px; padding: 6px;">
                                <foreignObject width="100%" height="100%">
                                    <i class="fas fa-stopwatch" style="color: white;font-size: 17px;float: left;margin-top: 6px;margin-left: 5px;"></i>
...
{{--        LMS         --}}
            @if($topshiriq_javob && $topshiriq_javob->status == 1)
                <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg125.svg);background-size: cover;height: 72px; margin-bottom: 15px">
                    ...
                    <div class="col-7 text-center">
                        <h6 style="font-family: Supercell-Magic;font-size: 13px;color: #131313;margin-top: 10px">{{$topshiriq_name->name}}</h6>
                        <svg width="100%" height="30">
                            <text x="10" y="15" font-family="Supercell-Magic" font-size="17" fill="white" stroke="#d6ba93" stroke-width="1">Topshiriq bajarildi</text>
                        </svg>
                    </div>
                    <div class="col-2" style="padding: 0 !important;">
                        <h6 style="font-family: Supercell-Magic;font-size: 13px;color: white;">Yutuq</h6>
                        <span style="font-family: Supercell-Magic;font-size: 10px;color: white;">
                        {{$topshiriq_name->star}}
                        </span>
                        <img src="{{asset('images/jang_topshiriq/sovrin.svg')}}" width="45" alt="">
{{--                        <img src="{{asset('images/jang_topshiriq/toj.svg')}}" height="30" alt="">--}}
                    </div>
                </div>
            ...
            @else
                <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg100.svg);margin-bottom: 15px;background-size: cover;height: 105px;background-repeat: no-repeat;width: 470px;">
                    ...
                    <div class="col-7" style="padding: 0 !important;text-align: center">
                        <h6 style="font-family: Supercell-Magic; font-size: 14px; color: white;margin-bottom: 0 !important;margin-top: 20px">{{$topshiriq_name->name}}</h6>
                        <div style="margin-top: 15px;margin-bottom: 15px;">
                            <svg width="150" height="35" style="background: #0c60ac; border-radius: 8px; padding: 6px;">
                                <foreignObject width="100%" height="100%">
                                    <i class="fas fa-stopwatch" style="color: white;font-size: 17px;float: left;margin-top: 6px;margin-left: 5px;"></i>
                    ...
                    <div class="col-2" style="padding: 0 !important;">
                        <h6 style="font-family: Supercell-Magic;font-size: 13px;color: white;text-align: center">Sovrin</h6>
                        <span style="font-family: Supercell-Magic;font-size: 10px;color: white;margin-left: 11px">
                        {{$topshiriq_name->star}}
                        </span>
                        <img src="{{asset('images/jang_topshiriq/sovrin.svg')}}" width="45" alt="">
                    </div>
...
{{--    END LMS    --}}
        ...
        @if($smena_topshiriq_javob && $smena_topshiriq_javob->status == 1)
            <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg125.svg);background-size: cover;height: 72px; margin-bottom: 15px">
                ...
                <div class="col-7 text-center">
                    <h6 style="font-family: Supercell-Magic;font-size: 13px;color: #131313;margin-top: 10px">{{$smena_topshiriq->name}}</h6>
                    <svg width="100%" height="30">
                        <text x="10" y="15" font-family="Supercell-Magic" font-size="17" fill="white" stroke="#d6ba93" stroke-width="1">Topshiriq bajarildi</text>
                    </svg>
                </div>
        ...
        @else
            <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg100.svg);margin-bottom: 15px;background-size: cover;height: 105px;background-repeat: no-repeat;width: 470px;">
                ...
                <div class="col-7" style="padding: 0 !important;text-align: center">
                    <h6 style="font-family: Supercell-Magic; font-size: 14px; color: white;margin-bottom: 0 !important;margin-top: 20px">{{$smena_topshiriq->name}}</h6>
                    <div style="margin-top: 15px;margin-bottom: 15px;">
                        <svg width="150" height="35" style="background: #0c60ac; border-radius: 8px; padding: 6px;">
                            <foreignObject width="100%" height="100%">
                                <i class="fas fa-stopwatch" style="color: white;font-size: 17px;float: left;margin-top: 6px;margin-left: 5px;"></i>
...
{{--        Savdo 300--}}
        @if($savdo_topshiriq_javob && $savdo_topshiriq_javob->status == 1)
            <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg125.svg);background-size: cover;height: 72px; margin-bottom: 15px">
                ...
                <div class="col-7 text-center">
                    <h6 style="font-family: Supercell-Magic;font-size: 13px;color: #131313;margin-top: 10px">{{$savdo_topshiriq_name->name}}</h6>
                    <svg width="100%" height="30">
                        <text x="10" y="15" font-family="Supercell-Magic" font-size="17" fill="white" stroke="#d6ba93" stroke-width="1">Topshiriq bajarildi</text>
                    </svg>
                </div>
        ...
        @else
            <div class="row align-items-center justify-content-center" style="background-image: url(/images/jang_topshiriq/svg100.svg);margin-bottom: 15px;background-size: cover;height: 105px;background-repeat: no-repeat;width: 470px;">
                ...
                <div class="col-7" style="padding: 0 !important;text-align: center">
                    <h6 style="font-family: Supercell-Magic; font-size: 14px; color: white;margin-bottom: 0 !important;margin-top: 20px">{{$savdo_topshiriq_name->name}}</h6>
                    <div style="margin-top: 15px;margin-bottom: 15px;">
                        <svg width="150" height="35" style="background: #0c60ac; border-radius: 8px; padding: 6px;">
                            <foreignObject width="100%" height="100%">
                                <i class="fas fa-stopwatch" style="color: white;font-size: 17px;float: left;margin-top: 6px;margin-left: 5px;"></i>
