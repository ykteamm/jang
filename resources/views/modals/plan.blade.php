<div class="modal fade" id="plan" tabindex="-1" role="dialog" aria-labelledby="Plan" aria-hidden="true">
                ...
                <div class="modal-body p-0">
                    <div class="container p-0">
                        <div class="mb-3 pt-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12"  style="border: 1px solid gray;padding-top: 10px;text-align: center;">
                                                        @foreach (getShogirdUser() as $key => $item)
                                                            ...
                                                            <h6 style="color: red">
                                                                <input type="text" id="month_plan_jamoa" style="text-align: center" value="{{$month_plan->oylik_plan}}" disabled>
                                                            </h6>
                                                            @endif
                                                        @endforeach
                                                    </div>
                            ...
                            <form action="{{route('month_plan')}}" method="POST">
                                @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12"  style="border: 1px solid gray;padding-top: 10px;text-align: center;">
                                                                ...
                                                                <h6 style="color: white">
                                                                    <input type="text" name="user_plan[]"  id="month_plan{{$item->id}}">
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            @endforeach
                                <div class="text-center" style="display: none;" id="save_plan">
