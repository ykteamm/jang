        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card mb-3">
                    ...
                    {{-- <div class="form-group text-center" id="for-pro-select-p">
